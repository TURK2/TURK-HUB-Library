...
function Library:CreateWindow(Config)
    ...
    local MainWidth = math.clamp(View.X * 0.8, 340, 580)
    ...
    -- [ 📂 Sidebar (Tabs) - เลื่อนแนวตั้งตรงๆ ]
    local SideWidth = isMobile and 115 or 145
    local Side = Instance.new("ScrollingFrame", Main); Side.Name = "SideBar"
    Side.Size = UDim2.new(0, SideWidth, 1, -65); Side.Position = UDim2.new(0, 12, 0, 55)
    Side.BackgroundTransparency = 1; Side.ScrollBarThickness = 0
    Side.CanvasSize = UDim2.new(0, 0, 0, 0) -- ล็อคแนวนอน (X = 0)
    Side.AutomaticCanvasSize = Enum.AutomaticSize.Y -- เลื่อนได้แค่แนวตั้ง
    ...
    function Tabs:CreateTab(name)
        -- ปุ่ม Tab ปรับให้กว้างพอดี SideBar
        ...
        -- หน้า Page ปรับให้เลื่อนแนวตั้งตรงๆ
        ...
        Page.CanvasSize = UDim2.new(0, 0, 0, 0) -- ล็อคแนวนอน (X = 0)
        Page.AutomaticCanvasSize = Enum.AutomaticSize.Y -- เลื่อนได้แค่แนวตั้ง
        ...
        function E:CreateSection(n) 
            ECount = ECount + 1
            local SFrame = Instance.new("Frame", Page); SFrame.Size = UDim2.new(1, -5, 0, 25); SFrame.BackgroundTransparency = 1; SFrame.LayoutOrder = ECount
        ...
        function E:CreateButton(D) 
            ECount = ECount + 1
            local b = Instance.new("TextButton", Page); b.Size = UDim2.new(1,-5,0,38); b.BackgroundColor3 = Theme.Element; b.Text = D.Name; b.TextColor3 = Theme.Text; b.Font = "GothamBold"; b.TextSize = 13; b.LayoutOrder = ECount; Instance.new("UICorner", b).CornerRadius = UDim.new(0, 8)
        ...
        function E:CreateToggle(D) 
            ...
            local t = Instance.new("TextButton", Page); t.Size = UDim2.new(1,-5,0,38); t.BackgroundColor3 = Theme.Element; t.Text = "    "..D.Name; t.TextColor3 = Theme.Text; t.Font = "GothamBold"; t.TextSize = 13; t.TextXAlignment = "Left"; t.LayoutOrder = ECount; Instance.new("UICorner", t).CornerRadius = UDim.new(0, 8)
